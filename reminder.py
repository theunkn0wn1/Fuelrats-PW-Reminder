...
strEvent2 =  [':MechaSqueak[BOT]!sopel@bot.fuelrats.com', 'PRIVMSG', '#ratchat', ':Case', 'HWM', 'Merlin', 'cleared!', 'SC', 'Davros,', 'do', 'the', 'Paperwork:', 'http://t.fuelr.at/gsc']
...
strEvent3 = [':RatMama[BOT]!RatMama@bot.fuelrats.com', 'PRIVMSG', '#ratchat', ':[API]', 'Paperwork', 'for', 'rescue', 'of', 'HWM', 'in', 'NYEAJEE', 'SE-X', 'A28-4', 'has', 'been', 'completed', 'by', 'SC Davros,']
strEvent4 = strEvent2
#strEvent4[7] = 'potato'
def log(trace,msg,color=19):
	print("[{Stack}:{trace}]\t \003{color}{message}".format(Stack = __module_name__,message = msg,trace=trace,color=color))
##
######
...
def init():
	...
	log("init","Done!")
	log("Init","-----------------\n{} version {} loaded successfully!\n--------------".format(__module_name__,__module_version__),03)
init()
